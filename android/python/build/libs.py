...
libmpg123 = AutotoolsProject(
    'https://mpg123.de/download/mpg123-1.32.10.tar.bz2',
...
libfaad = AutotoolsProject(
    'https://sourceforge.net/projects/faac/files/faad2-src/faad2-2.8.0/faad2-2.8.8.tar.gz',
    '28f6116efdbe9378269f8a6221767d1f',
    'lib/libfaad.a',
    [
        '--disable-shared', '--enable-static'
    ],
...
# ld.lld: error: libcrypto.a(aes-gcm-avx2-x86_64-apple.S.o) is incompatible with aarch64linux ????
libssl = CmakeProject(
    'https://github.com/google/boringssl/releases/download/0.20250514.0/boringssl-0.20250514.0.tar.gz',
    '74d36c25e53d78602b8e8e106cf01263',
    'lib/libssl.a',
    [
